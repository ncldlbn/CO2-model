...
class Contadino:
    def __init__(self, id, distanza, uba, biomassa_uba_giorno, perc_letame, deposito_0, deposito_max, GWP_CH4, GWP_NO2):
        ...
        deposito_0 (int): Quantità iniziale di biomassa presente nel deposito (in t).
        deposito_max (int): Capacità massima del deposito di stoccaggio (in t).
        ...
        self.deposito_0 = deposito_0*1000
        self.deposito_max = deposito_max*1000
        self.deposito = {}
        self.tot_co2eq = 0
